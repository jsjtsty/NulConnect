...
Environment overrides:
  LIBREATRUST_VERSION       libreatrust release tag (default: v0.2.6)
  NULCONNECT_HELPER_VERSION helper release tag (default: v0.2.6)
...
LIBREATRUST_VERSION="${LIBREATRUST_VERSION:-v0.2.6}"
NULCONNECT_HELPER_VERSION="${NULCONNECT_HELPER_VERSION:-v0.2.6}"
