...
- [libreatrust v0.2.3](https://github.com/jsjtsty/libreatrust)
- [nulconnect-helper v0.2.3](https://github.com/jsjtsty/nulconnect-helper)
...
```bash
LIBREATRUST_VERSION=v0.2.3 \
NULCONNECT_HELPER_VERSION=v0.2.3 \
scripts/update-dependencies.sh --arch arm64
```
